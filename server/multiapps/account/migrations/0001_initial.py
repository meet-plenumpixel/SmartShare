    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('borrower', models.ForeignKey(limit_choices_to={'is_superuser': False}, on_delete=django.db.models.deletion.PROTECT, related_name='borrowers', to=settings.AUTH_USER_MODEL)),
            ],
            options={
